...
namespace JPOGStegosaurus {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var bundleName = "jpogstegosaurusassets";
            ...
            /*
            var JPOGStegosaurusLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var JPOGStegosaurusCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
